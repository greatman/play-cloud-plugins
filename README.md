Cloud Plugins for Play! Framework [![Build Status](https://travis-ci.org/SpoutDev/play-cloud-plugins.png?branch=master)](https://travis-ci.org/SpoutDev/play-cloud-plugins)
==================
